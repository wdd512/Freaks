...
const outputDirectory = path.resolve(process.cwd(), argument("output") ?? "art-output/mini-collection-v1");
...
const generated = generateCollection(MINI_COLLECTION_V1_COUNT, MINI_COLLECTION_V1_SEED).freaks;
...
const qaReport = {
  ...buildMiniCollectionQaReport(entries, missingImageLayers),
...
console.log(`Mini Collection V1: ${qaReport.rendersCompleted}/${entries.length} renders completed`);
...
console.log(`Duplicate render signatures: ${qaReport.duplicateRenderSignatureCount}`);
